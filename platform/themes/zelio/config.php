...
return [
    ...
    'events' => [
        'beforeRenderTheme' => function (Theme $theme): void {
            ...
            $theme->asset()->usePath()->add('poligonium-header', 'css/poligonium-header.css', version: $version);
            $theme->asset()->usePath()->add('poligonium-sections', 'css/poligonium-sections.css', version: $version);
            $theme->asset()->usePath()->add('poligonium-services-page', 'css/poligonium-services-page.css', version: $version);
            $theme->asset()->usePath()->add('uk-font', 'css/uk-font.css', version: $version);
            ...
            $theme->asset()->container('footer')->usePath()->add('poligonium-services-page', 'js/poligonium-services-page.js', ['main'], version: $version);
            $theme->asset()->container('footer')->usePath()->add('poligonium-vfx-showreel', 'js/poligonium-vfx-showreel.js', ['main'], version: $version);
            $theme->asset()->container('footer')->usePath()->add('poligonium-contact-tab', 'js/poligonium-contact-tab.js', ['main'], version: $version . '.contact-tab-5');
